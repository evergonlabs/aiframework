/// Tree-sitter based C# parser — more accurate than regex.
...
pub fn parse(content: &str, filepath: &str) -> (Vec<Symbol>, Vec<String>, Vec<String>) {
    ...
    if parser.set_language(&language.into()).is_err() {
        return super::csharp::parse(content, filepath);
    }

    let tree = match parser.parse(content, None) {
        Some(t) => t,
        None => return super::csharp::parse(content, filepath),
    };
