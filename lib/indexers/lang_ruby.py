...
def parse_ruby(filepath: str, content: str) -> dict[str, Any]:
    ...
    for m in re.finditer(
        ...
        # A method is private if any `private` keyword appeared before it
        # at the same or outer indentation scope (simplified: any private before).
        vis = "public"
        for pl in private_lines:
            if pl < line:
                vis = "private"
        # Underscore-prefixed methods are also private by convention.
